...
**Date:** 2026-07-19 · **Source:** rightmove.co.uk commercial-property-for-sale (search pages, `__NEXT_DATA__` plain JSON) · **Mode:** read-only live pull

Searched **7 cities** (Citywide footprint: Yorkshire + Greater Manchester). Portal reports **870** matching results across those searches; fetched a capped **554** (max 5 pages/city, 1.5 s between requests), **554** after cross-city dedupe. **95** business-for-sale going concerns excluded by subtype, leaving **459** investable listings. Stage-0 (minimum bar **2**, geography excluded from scoring — see below) passed **188**.
...
**156 distinct agents/branches** appear in the 554 fetched listings (counted before the subtype filter — coverage is a property of the portal, not of our filtering) — vs one agent per bespoke source. 92 distinct agents appear in the Stage-0-passed set.
...
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Sheffield Yorkshire" in Educating Excellence territory (prescoped — not scored); size 28497 >= min 2000; keyword hit "freehold"
...
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Sheffield Yorkshire" in Educating Excellence territory (prescoped — not scored); size 97574 >= min 2000; keyword hit "freehold"
...
- **Agent:** Crosthwaite Commercial Limited, Sheffield
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Sheffield Yorkshire" in Educating Excellence territory (prescoped — not scored); size 44179 >= min 2000; keyword hit "development opportunity"
...
- **Listing:** https://www.rightmove.co.uk/properties/168968636#/?channel=COM_BUY
...
- **Agent:** GV&Co, Leeds
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Sheffield Yorkshire" in Educating Excellence territory (prescoped — not scored); size 36381 >= min 2000; keyword hit "freehold"
...
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Sheffield Yorkshire" in Educating Excellence territory (prescoped — not scored); size 42195 >= min 2000; keyword hit "freehold"
...
- **Agent:** Roger Hannah Ltd, Manchester
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Manchester Greater Manchester" in Educating Excellence territory (prescoped — not scored); size 47916 >= min 2000; keyword hit "freehold"
...
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Manchester Greater Manchester" in Educating Excellence territory (prescoped — not scored); size 21507 >= min 2000; keyword hit "freehold"
...
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Bolton Greater Manchester" in Educating Excellence territory (prescoped — not scored); size 28211 >= min 2000; keyword hit "planning"
...
- **Agent:** Savills, Manchester - Licensed Leisure
- **Matched requirement:** Educating Excellence (score 2/2+)
- **Why:** geography "Bolton Greater Manchester" in Educating Excellence territory (prescoped — not scored); size 35719 >= min 2000; keyword hit "freehold"
...
271 investable listings scored below the bar (geography not scored — these counts reflect price/size/keyword signals only).

| Best score | Listings | Typical shortfall |
|---|---|---|
| 0/2 | 96 | no non-geo signal at all (POA price, no size given, no keyword hit) |
| 1/2 | 175 | one signal only — e.g. keyword but price outside budget / size unknown |
