...
**Date:** 2026-07-12 · **Source:** https://www.barnsdales.co.uk/properties · **Mode:** read-only live pull

Scraped **105** properties from the embedded `var properties` array; **4** passed the documented commercial-freehold filter (`freehold_from` not null, `residential === false`, status Available / Coming Soon). Stage-0 (minimum bar **2** of 4) then passed **2**.
...
|---|---|---|---|---|
| Doncaster, DN1 3EA | £425,000 | 2776 sqft | 1/2 | geography "Doncaster Yorkshire" matches Citywide Investors |
| Bawtry, DN10 6XB | £100,000 | Menagerie Wood 5.13 acres | 1/2 | geography "Bawtry Yorkshire" matches Citywide Investors |
